...
Detailed output templates for internal-linking-optimizer steps 5-8. Referenced from [SKILL.md](../SKILL.md).

---

## Step 5: Create Topic Cluster Link Strategy
...
## Step 6: Find Contextual Link Opportunities
...
## Step 7: Optimize Navigation and Footer Links
...
## Step 8: Generate Link Implementation Plan
